...
<head>
    ...
    <link rel="icon" href="img/hnglogo.png" />
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="https://internship.zuri.team"><img class="img-fluid rounded align-self-center" src="img/hnglogo.png" alt="Adeoluwa Adeboye" width="30px"></img>HNG/i4g</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center p-3" style="color: black;">
                    ...
                    <a href="https://internship.zuri.team"><img class="img-fluid rounded align-self-center" src="img/hnglogo.png" alt="Adeoluwa Adeboye" width="30px" style="color: black;"></img> HNG/i4g</a>
